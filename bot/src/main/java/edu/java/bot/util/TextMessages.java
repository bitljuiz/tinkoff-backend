...
public class TextMessages {
    ...
    public static final String INVALID_FORMAT_TRACK_MESSAGE = "Invalid link. Try, for example " + TRACK_COMMAND + " github.com";
    ...
    public static final String INVALID_FORMAT_UNTRACK_MESSAGE = "Invalid link. Try, for example " + UNTRACK_COMMAND + " github.com";
